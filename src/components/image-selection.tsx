...
export default function ImageUploadComponent({
  ...
  return (
    <div className="container mx-auto p-4 ">
      <label className="flex absolute left-0 bottom-0 mx-7 translate-y-[5px] mb-3">
        <svg
          className="w-6 h-6 mt-[6px] hover:cursor-pointer transform-gpu active:scale-75 transition-all text-neutral-500"
      ...
      {preview && (
        <div className="w-full p-2">
          <img src={preview} alt="Selected" className="object-cover w-32 h-32" />
          <button
